  ...
  <table width="100%" cellspacing="0" cellpadding="5">
    <tr>
      ...
      <td align="middle">
       ...
       $stmt = $pdo->query ('call auto_add_curr');
       $stmt = $pdo->query ('call auto_day_left');
       $stmt = $pdo->query ('call auto_dis');      
       ...
       echo   '<table class="scroll" align="center" border ="1">
           ...
           for($i = 0; $i < count($prod); $i++){
            ...
            echo '</tbody>
                  ...
                  echo '<font color="#454545" size ="6"><b>Склад пуст</b></font>';} ?>
      </td>
      <td align="left" width="20%" valign="top">
        ...
        <br>
        <br>
        <form action="/WEB-APP/script/sklad/after_search.php" METHOD="post">
          ...
          <tbody>
            ...
            $stmt = $pdo->query ('SELECT Prod,Kol,m
                                  FROM (
                                    ...
                                    WHERE ( ((A.Kol < 20) AND ((A.m="кг") OR (A.m="шт"))) OR ((A.Kol < 40) AND (A.m="л")) )');
                 while ($row = $stmt->fetch()) {
                 echo '<tr>';
